// ================================================================================
// lrtf_bridge.cpp — JSON bridge for Longest Remaining Time First (Preemptive).
// Identical pattern to fcfs_bridge.cpp — see that file for full notes.
// ================================================================================

#define main lrtf_original_main
#include "../cpp/LRTF_optimal.cpp"
#undef main
