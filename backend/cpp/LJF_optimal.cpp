...
// on the CPU by a single process. LJF is non-preemptive, so
...
// Max Heap stores {Burst Time, -Arrival Time, Index}
//
// Algorithm:
// 1. Sort processes by Arrival Time.
// 2. Push all arrived processes into the Max Heap, on basis of longest Burst Time.
// 3. Pop the process with the longest Burst Time.
...
// The original heap-selection logic is completely untouched.
// ============================================================
...
// ============================================================
// runLJFScheduling is the ONE function FastAPI will call (via
...
// ============================================================
SimulationResult runLJFScheduling(const vector<ProcessInput>& processInputs){
